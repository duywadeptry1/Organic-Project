...
function useApplePayOneTimePaymentSession({
  ...
  const handleClick = useCallback(async () => {
    ...
    if (typeof window === "undefined" || typeof ApplePaySession === "undefined" || !ApplePaySession.canMakePayments()) {
...
function useGooglePayOneTimePaymentSession({
  ...
  }, [googlePayConfig, environment, proxyCallbacks, sdkInstance, setError, isMountedRef]);
